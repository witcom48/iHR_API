...
{
    public class cls_ctTRTimeonsite
    {
        string Message = string.Empty;

        cls_ctConnection Obj_conn = new cls_ctConnection();

        public cls_ctTRTimeonsite() { }
        ...
        private List<cls_TRTimeonsite> getData(string language, string condition)
        {
            ...
            try
            {
                ...
                obj_str.Append(" HRM_TR_TIMEONSITE.COMPANY_CODE");
                obj_str.Append(", HRM_TR_TIMEONSITE.WORKER_CODE");
                ...
                obj_str.Append(", ISNULL(HRM_TR_TIMEONSITE.REASON_CODE, '') AS REASON_CODE");
                obj_str.Append(", ISNULL(HRM_TR_TIMEONSITE.LOCATION_CODE, '') AS LOCATION_CODE");
                ...
                obj_str.Append(", ISNULL(HRM_TR_TIMEONSITE.MODIFIED_BY, HRM_TR_TIMEONSITE.CREATED_BY) AS MODIFIED_BY");
                obj_str.Append(", ISNULL(HRM_TR_TIMEONSITE.MODIFIED_DATE, HRM_TR_TIMEONSITE.CREATED_DATE) AS MODIFIED_DATE");

                obj_str.Append(" FROM HRM_TR_TIMEONSITE");

                obj_str.Append(" INNER JOIN HRM_MT_WORKER ON HRM_MT_WORKER.COMPANY_CODE=HRM_TR_TIMEONSITE.COMPANY_CODE AND HRM_MT_WORKER.WORKER_CODE=HRM_TR_TIMEONSITE.WORKER_CODE");
                obj_str.Append(" INNER JOIN HRM_MT_INITIAL ON HRM_MT_INITIAL.INITIAL_CODE=HRM_MT_WORKER.WORKER_INITIAL ");

                obj_str.Append(" LEFT JOIN HRM_MT_REASON ON HRM_MT_REASON.REASON_CODE=HRM_TR_TIMEONSITE.REASON_CODE AND REASON_GROUP = 'ONSITE'");
                obj_str.Append(" LEFT JOIN HRM_MT_LOCATION ON HRM_MT_LOCATION.LOCATION_CODE=HRM_TR_TIMEONSITE.LOCATION_CODE ");
                ...
                obj_str.Append(" ORDER BY HRM_TR_TIMEONSITE.COMPANY_CODE, HRM_TR_TIMEONSITE.WORKER_CODE, TIMEONSITE_WORKDATE");
            ...
            {
                Message = "ERROR::(Timeonsite.getData)" + ex.ToString();
            }

            return list_model;
        }

        public List<cls_TRTimeonsite> getDataByFillter(string language, string com, string emp, DateTime datefrom, DateTime dateto)
        {
            string strCondition = "";

            strCondition += " AND HRM_TR_TIMEONSITE.COMPANY_CODE='" + com + "'";
            strCondition += " AND HRM_TR_TIMEONSITE.WORKER_CODE='" + emp + "'";
        ...
        public bool checkDataOld(string com, string emp, DateTime date)
        {
            ...
            {
                Message = "ERROR::(Timeonsite.checkDataOld)" + ex.ToString();
            }
        ...
        public int getNextID()
        {
            ...
            try
            {
                ...
                obj_str.Append("SELECT MAX(TIMEONSITE_ID) ");
                obj_str.Append(" FROM HRM_TR_TIMEONSITE");             
            ...
            {
                Message = "ERROR::(Timeonsite.getNextID)" + ex.ToString();
            }
        ...
        public bool delete(string id)
        {
            ...
            try
            {
                ...
                obj_str.Append(" DELETE FROM HRM_TR_TIMEONSITE");
                obj_str.Append(" WHERE 1=1 ");
            ...
            {
                blnResult = false;
                Message = "ERROR::(Timeonsite.delete)" + ex.ToString();
            }

            return blnResult;
        }
        
        public bool insert(cls_TRTimeonsite model)
        {
            bool blnResult = false;
            try
            {
                ...
                obj_str.Append("INSERT INTO HRM_TR_TIMEONSITE");
                obj_str.Append(" (");
            ...
            {
                Message = "ERROR::(Timeonsite.insert)" + ex.ToString();
            }

            return blnResult;
        }

        public bool update(cls_TRTimeonsite model)
        {
            bool blnResult = false;
            try
            {
                ...
                obj_str.Append("UPDATE HRM_TR_TIMEONSITE SET ");
            ...
            {
                Message = "ERROR::(Timeonsite.update)" + ex.ToString();
            }
