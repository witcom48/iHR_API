...
{
    class cls_ctFNTComparefixamount
    {
        ...
        private List<cls_FNTComparefixamount> getData(string condition)
        {
            ...
            try
            {
                ...
                obj_str.Append(" FROM HRM_FNT_COMPAREFIX_AMOUNT('12/25/2023', '11/24/2023', 'APT', 'OT01')");
        ...
        public List<cls_FNTComparefixamount> getDataByFillter(int id, string user)
        {
            string strCondition = "";
            if (!id.Equals(""))
        ...
        public bool delete(int id)
        {
            ...
            try
            {
                ...
                obj_str.Append(" DELETE FROM HRM_FNT_COMPAREFIX_AMOUNT('12/25/2023', '11/24/2023', 'APT', 'OT01')");
                obj_str.Append(" WHERE EmpID='" + id + "'");
        ...
        //        public string insert(cls_FNTComparefixamount model)

        public bool insert2(string empId, List<cls_FNTComparefixamount> list_model)
        {
            bool blnResult = false;
            try
            {
                ...
                obj_str.Append("INSERT INTO HRM_FNT_COMPAREFIX_AMOUNT('12/25/2023', '11/24/2023', 'APT', 'OT01')");
                obj_str.Append(" (");
                obj_str.Append("EmpID ");
                obj_str.Append(", EmpName ");
                obj_str.Append(", Amount ");
                ...
                obj_str2.Append(" DELETE FROM HRM_FNT_COMPAREFIX_AMOUNT('12/25/2023', '11/24/2023', 'APT', 'OT01')");
                ...
                if (blnResult)
                {
                    ...
                    foreach (cls_FNTComparefixamount model in list_model)
                    {
        ...
        public string update(cls_FNTComparefixamount model)
        {
            string blnResult = "";
            try
            {
                ...
                obj_str.Append("UPDATE HRM_FNT_COMPAREFIX_AMOUNT('12/25/2023', '11/24/2023', 'APT', 'OT01') SET ");
