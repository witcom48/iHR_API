    ...
    public class cls_ctMTCompany
    {
        ...
        public int comcount()
        {
            ...
            try
            {
                ...
                obj_str.Append("select COUNT(COMPANY_CODE) as comcount from HRM_MT_COMPANY");
            ...
            {
                Message = "ERROR::(HRM_MT_COMPANY.count)" + ex.ToString();
            }
        ...
        public string insert(cls_MTCompany model)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(this.Decrypt(listPackage[0].packege_com).Split('C')[1]) <= comcount)
                {
                    return "limit";
                }
                cls_ctConnection obj_conn = new cls_ctConnection();
