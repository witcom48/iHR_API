...
{
   public class cls_ctTRPayPtimeleaveDash
    {
        string Message = string.Empty;

        cls_ctConnection Obj_conn = new cls_ctConnection();

        public cls_ctTRPayPtimeleaveDash() { }
        ...
        private List<cls_TRPayPtimeleaveDash> getData(string condition)
        {
            List<cls_TRPayPtimeleaveDash> list_model = new List<cls_TRPayPtimeleaveDash>();
            cls_TRPayPtimeleaveDash model;
            try
            {
                ...
                {
                    model = new cls_TRPayPtimeleaveDash();
