...
namespace ClassLibrary_BPC.hrfocus.controller
{
    public class cls_ctTRTimeot
    {
        ...
        //
        public bool insertlist(string com, string emp,  DateTime datefrom, DateTime dateto, List<cls_TRTimeot> list_model)
        {
            bool blnResult = false;
            cls_ctConnection obj_conn = new cls_ctConnection();
            try
            {
                ...
                if (blnResult)
                {
                    ...
                    obj_cmd.Parameters.Add("@TIMEOT_ID", SqlDbType.Int);  
                    obj_cmd.Parameters.Add("@TIMEOT_DOC", SqlDbType.VarChar); 
                    obj_cmd.Parameters.Add("@TIMEOT_WORKDATE", SqlDbType.Date);  
 
                    obj_cmd.Parameters.Add("@TIMEOT_BEFOREMIN", SqlDbType.Int);  
                    obj_cmd.Parameters.Add("@TIMEOT_NORMALMIN", SqlDbType.Int);  
                    obj_cmd.Parameters.Add("@TIMEOT_AFTERMIN", SqlDbType.Int);  
                    obj_cmd.Parameters.Add("@TIMEOT_BREAK", SqlDbType.Int);  

                    obj_cmd.Parameters.Add("@TIMEOT_NOTE", SqlDbType.VarChar);  
                    ...
                    foreach (cls_TRTimeot model in list_model)
                    {

                         obj_cmd.Parameters["@COMPANY_CODE"].Value = model.company_code;
                         obj_cmd.Parameters["@WORKER_CODE"].Value = model.worker_code;

                         obj_cmd.Parameters["@TIMEOT_ID"].Value = this.getNextID();
                          obj_cmd.Parameters["@TIMEOT_DOC"].Value = model.timeot_doc;
                        obj_cmd.Parameters["@TIMEOT_WORKDATE"].Value = model.timeot_workdate;
 
                        obj_cmd.Parameters["@TIMEOT_BEFOREMIN"].Value = model.timeot_beforemin;
                         obj_cmd.Parameters["@TIMEOT_NORMALMIN"].Value = model.timeot_normalmin;
                        obj_cmd.Parameters["@TIMEOT_AFTERMIN"].Value = model.timeot_aftermin;
                         obj_cmd.Parameters["@TIMEOT_BREAK"].Value = model.timeot_break;

                         obj_cmd.Parameters["@TIMEOT_NOTE"].Value = model.timeot_note;
