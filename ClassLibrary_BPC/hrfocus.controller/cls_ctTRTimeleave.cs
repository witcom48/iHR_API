...
namespace ClassLibrary_BPC.hrfocus.controller
{
    public class cls_ctTRTimeleave
    {
        ...
        private List<cls_TRTimeleave> getData(string language, string condition)
        {
            ...
            try
            {
                ...
                obj_str.Append(" HRM_TR_TIMELEAVE.COMPANY_CODE");
                obj_str.Append(", HRM_TR_TIMELEAVE.WORKER_CODE");
                ...
                obj_str.Append(", HRM_TR_TIMELEAVE.LEAVE_CODE");
                obj_str.Append(", ISNULL(REASON_CODE, '') AS REASON_CODE");

                obj_str.Append(", ISNULL(HRM_TR_TIMELEAVE.MODIFIED_BY, HRM_TR_TIMELEAVE.CREATED_BY) AS MODIFIED_BY");
                obj_str.Append(", ISNULL(HRM_TR_TIMELEAVE.MODIFIED_DATE, HRM_TR_TIMELEAVE.CREATED_DATE) AS MODIFIED_DATE");

                obj_str.Append(" FROM HRM_TR_TIMELEAVE");

                obj_str.Append(" INNER JOIN HRM_MT_WORKER ON HRM_MT_WORKER.COMPANY_CODE=HRM_TR_TIMELEAVE.COMPANY_CODE AND HRM_MT_WORKER.WORKER_CODE=HRM_TR_TIMELEAVE.WORKER_CODE");
                obj_str.Append(" INNER JOIN HRM_MT_INITIAL ON HRM_MT_INITIAL.INITIAL_CODE=HRM_MT_WORKER.WORKER_INITIAL ");
                obj_str.Append(" INNER JOIN HRM_MT_LEAVE ON HRM_MT_LEAVE.COMPANY_CODE=HRM_TR_TIMELEAVE.COMPANY_CODE AND HRM_MT_LEAVE.LEAVE_CODE=HRM_TR_TIMELEAVE.LEAVE_CODE");
                ...
                obj_str.Append(" ORDER BY HRM_TR_TIMELEAVE.COMPANY_CODE, HRM_TR_TIMELEAVE.WORKER_CODE, TIMELEAVE_FROMDATE");
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    model.leave_detail = dr["LEAVE_DETAIL"].ToString();
        ...
        public List<cls_TRTimeleave> getDataByFillter(string language, string com, string emp, DateTime datefrom, DateTime dateto)
        {
            string strCondition = "";
            ...
            if (!emp.Equals(""))
            {
                strCondition += " AND HRM_TR_TIMELEAVE.WORKER_CODE='" + emp + "'";
            }
        ...
        public cls_TRTimeleave getDataByID(string id)
        {
            ...
            string strCondition = " AND HRM_TR_TIMELEAVE.TIMELEAVE_ID='" + id + "'";
     
            List<cls_TRTimeleave> list_model = this.getData("EN", strCondition);
        ...
        public bool delete(string id)
        {
            ...
            try
            {
                ...
                obj_str.Append(" DELETE FROM HRM_TR_TIMELEAVE");
                obj_str.Append(" WHERE 1=1 ");
        ...
        public bool insert(cls_TRTimeleave model)
        {
            bool blnResult = false;
            try
            {
                ...
                obj_str.Append("INSERT INTO HRM_TR_TIMELEAVE");
                obj_str.Append(" (");
        ...
        public bool update(cls_TRTimeleave model)
        {
            bool blnResult = false;
            try
            {
                ...
                obj_str.Append("UPDATE HRM_TR_TIMELEAVE SET ");
